function buildWikidataQuery(parliament, term, time) {
...
function generateLegend() {
	...
	for (result in resultsList) {
		...
		legend.innerHTML += "<span class='legendLabel'>" + resultsList[result].partyLabel.value + "</span><br/>"
	}
}
...
function update() {
	...
	points = [];
	document.getElementById("svgContainer").innerHTML = "";
	var url = buildWikidataQuery(parliamentParameter, termParameter, timeParameter);
